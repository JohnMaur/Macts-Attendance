...
app.post('/tagData', async (req, res) => {
  ...
  try {
    ...
    const studentResponse = await axios.get('https://macts-backend-webapp.onrender.com/studentInfo');
    ...
    if (matchedStudent) {
      ...
      const attendanceResponse = await axios.get('https://macts-backend-webapp.onrender.com/attendance');
